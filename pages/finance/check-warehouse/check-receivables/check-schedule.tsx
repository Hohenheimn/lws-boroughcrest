...
export default function CheckSchedule() {
  ...
  return (
    <TableCheckReceivables
      ...
      EndPointList={`/finance/customer-facility/check-schedule?paginate=10&filters=${isFilterText}&keyword=${isSearch}&page=${TablePage}&date_from=${dateFrom}&date_to=${dateTo}`}
      EndPointExport={`/finance/customer-facility/check-schedule/export?paginate=10&filters=${isFilterText}&keyword=${isSearch}&page=${TablePage}&date_from=${dateFrom}&date_to=${dateTo}`}
