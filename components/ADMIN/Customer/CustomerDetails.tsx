...
export default function CustomerDetail() {
  ...
  const { ImgUrl, setPrompt, cusToggle, setCusToggle } = useContext(AppContext);
  ...
  if (
    ...
    Logo =
      "https://boroughcrest-api.lws.codes/get-img?image=" + data?.image_photo;
  }
      ...
      <ul className=" w-full shadow-lg flex p-10 bg-white rounded-2xl flex-wrap mb-10">
        ...
        <li className="w-3/12 1280px:w-4/12 flex-col 480px:w-full p-5 flex justify-center items-center">
          <aside className=" w-6/12 820px:w-10/12 rounded-full overflow-hidden 480px:w-5/12 aspect-square relative shadow-xl">
            <Image src={Logo} alt="profile" layout="fill" objectFit="cover" />
          </aside>
          <Tippy content={`${data?.status}`} theme="ThemeRed">
            <div className={"my-2 statusCircle " + data?.status}></div>
          </Tippy>
        ...
        <li className=" w-9/12 1280px:w-8/12  480px:w-full flex flex-wrap items-start">
          <ul className="flex flex-wrap">
            <li className=" w-4/12 mb-5 1280px:w-2/4 480px:w-full 480px:mb-3">
              <p className=" text-gray-400 1024px:text-[14px]">ID</p>
            ...
            <li className=" w-4/12 mb-5 1280px:w-2/4 480px:w-full 480px:mb-3">
              <p className=" text-gray-400 1024px:text-[14px]">CLASS</p>
              <h4 className=" text-gray-500 mb-5 1024px:text-[14px]">
                {data?.class}
              </h4>
            </li>
            <li className=" w-4/12 mb-5 1280px:w-2/4 480px:w-full 480px:mb-3">
              <p className=" text-gray-400 1024px:text-[14px]">TYPE</p>
              <h4 className=" text-gray-500 mb-5 1024px:text-[14px]">
                {data?.type}
              </h4>
            </li>
            <li className=" w-4/12 mb-5 1280px:w-2/4 480px:w-full 480px:mb-3">
              <p className=" text-gray-400 1024px:text-[14px]">TIN</p>
              <h4 className=" text-gray-500 mb-5 1024px:text-[14px]">
                {data?.tin}
              </h4>
            </li>
            <li className=" w-4/12 mb-5 1280px:w-2/4 480px:w-full 480px:mb-3">
              <p className=" text-gray-400 1024px:text-[14px]">PORTAL ID</p>
              <h4 className=" text-gray-500 mb-5 1024px:text-[14px]">
                {data?.user?.portal_id}
              </h4>
            </li>
            {data?.type !== "Company" && (
              <li className=" w-4/12 mb-5 1280px:w-2/4 480px:w-full 480px:mb-3">
                <p className=" text-gray-400 1024px:text-[14px]">CITIZENSHIP</p>
                <h4 className=" text-gray-500 mb-5 1024px:text-[14px]">
            ...
            <li className=" w-4/12 mb-5 1280px:w-2/4 480px:w-full 480px:mb-3">
              <p className=" text-gray-400 1024px:text-[14px]">VALID ID</p>
              <button
                className="mt-1 px-5 rounded-lg py-1 bg-ThemeRed text-white hover:bg-ThemeRed50 duration-75"
                onClick={() =>
                  setView((imgPass) => (imgPass = data?.image_valid_id))
                }
              >
                VIEW
              </button>
            ...
            <li className=" w-4/12 mb-5 1280px:w-2/4 480px:w-full 480px:mb-3">
              <p className=" text-gray-400 1024px:text-[14px]">SIGNATURE</p>
              <button
                className="mt-1 px-5 rounded-lg py-1 bg-ThemeRed text-white hover:bg-ThemeRed50 duration-75"
                onClick={() =>
                  setView((imgPass) => (imgPass = data?.image_signature))
                }
              >
                VIEW
              </button>
