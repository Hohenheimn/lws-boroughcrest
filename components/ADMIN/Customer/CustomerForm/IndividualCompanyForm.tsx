        ...
        <div>
          <ul className=" flex mb-5 flex-wrap 480px:mb-2">
            <li className=" border flex items-center w-4/12 820px:w-2/4 480px:w-full mb-5">
              ...
              {imgProfile.error !== "" && (
                <p className="text-[13px] font-NHU-bold">{imgProfile.error}</p>
              )}
            </li>
            <li className=" flex flex-col items-center justify-center w-4/12 820px:w-2/4 480px:w-full mb-5">
              <div>
                <input
                  ...
                  id="validid"
                  className="absolute z-[-99] w-0 overflow-hidden"
                  onChange={(e) => DisplayImage(e, setImgID, "validID")}
                />
                ...
                >
                  ...
                  <div>
                    UPLOAD VALID ID
                    {imgID.error !== "" && (
                      <p className="text-[13px] font-NHU-bold">{imgID.error}</p>
                    )}
                  </div>
                </label>
              </div>
          ...
          <ul className={style.ThreeRows}>
              ...
              <>
                <li>
                  ...
                  <input
                    type="text"
                    className="field"
                    value={isCustomerForm.individual_co_owner}
                    onChange={(e) => {
                      setCustomerForm({
                        ...isCustomerForm,
                ...
                <li>
                  ...
                  <CitizenDropdown
                    UpdateStateHandler={(value: string) => {
                      setCustomerForm({
                        ...isCustomerForm,
                        individual_citizenship: value,
                      });
                    }}
                    value={isCustomerForm.individual_citizenship}
                  />
            ...
            <li>
              ...
              {CusError?.branch_code !== "" && (
                <p className="text-[10px]">{CusError?.branch_code}</p>
              )}
            </li>
            ...
            <li>
              ...
              />
              {CusError?.portal_id !== "" && (
                <p className="text-[10px]">{CusError?.portal_id}</p>
              )}
            </li>
          </ul>
  ...
  const sameAddress = () => {
    ...
    if (!isSameAddress) {
      setCustomerForm({
        ...
        mailing_address_building: isCustomerForm.registered_address_building,
        mailing_address_street: isCustomerForm.registered_address_street,
        mailing_address_district: isCustomerForm.registered_address_district,
        mailing_address_municipal_city:
          isCustomerForm.registered_address_municipal_city,
        mailing_address_province: isCustomerForm.registered_address_province,
        mailing_address_zip_code: isCustomerForm.registered_address_zip_code,
      });
    } else {
      setCustomerForm({
        ...isCustomerForm,
      ...
      <form onSubmit={handleSubmit(NextFormValidation)}>
        <ul className={style.ThreeRows}>
          <li>
            ...
            {errors.contact_no && (
              <p className="text-[10px]">{errors.contact_no.message}</p>
            )}
            {CusError.contact_no !== "" && (
              <p className="text-[10px]">{CusError?.contact_no}</p>
            )}
          </li>
          <li>
            ...
            {errors.registered_email && (
              <p className="text-[10px]">{errors.registered_email.message}</p>
            )}
            {CusError.registered_email !== "" && (
              <p className="text-[10px]">{CusError?.registered_email}</p>
            )}
          </li>
          <li>
            ...
            {errors.preferred_email && (
              <p className="text-[10px]">{errors.preferred_email.message}</p>
            )}
            {CusError.preferred_email !== "" && (
              <p className="text-[10px]">{CusError?.preferred_email}</p>
            )}
            <aside className={style.checkboxContainer}>
              <input
                ...
                onChange={sameEmail}
              />
              <label htmlFor="sameEmail">SAME AS REGISTER EMAIL</label>
            </aside>
          </li>
          {isCustomerForm.type === "Company" && (
            <li>
        ...
        <ul className={style.ThreeRows}>
          <li>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setCustomerForm({
                  ...isCustomerForm,
                  registered_address_unit_floor: e.target.value,
                });
              }}
            />
          ...
          <li>
            ...
            <input
              className="field"
              type="text"
              value={isCustomerForm.registered_address_municipal_city}
              onChange={(e) => {
                if (!TextFieldValidation(e, 99999)) return;

                setCustomerForm({
                  ...isCustomerForm,
                  registered_address_municipal_city: e.target.value,
                });
              }}
            />
        ...
        <ul className={style.ThreeRows}>
          ...
          <li>
            ...
            <input
              className="field"
              type="text"
              value={isCustomerForm.mailing_address_municipal_city}
              onChange={(e) => {
                if (!TextFieldValidation(e, 99999)) return;

                setCustomerForm({
                  ...isCustomerForm,
                  mailing_address_municipal_city: e.target.value,
                });
              }}
            />
          </li>
