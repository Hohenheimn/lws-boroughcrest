              ...
              <>
                <div>
                  <Tippy theme="ThemeRed" content="Import">
                    <label className={styleSearch.icon} htmlFor="import">
                      <Image
            ...
            {isExportLoading ? (
              ...
              <div>
                <Tippy theme="ThemeRed" content="Export">
                  <div className={styleSearch.icon} onClick={ExportHandler}>
                    <Image
      ...
      <div className="table_container">
        <table className="table_list forCrud">
          ...
          <tbody>
            <tr>
              <td>
                <h1 className="text-end text-ThemeRed">TOTAL</h1>
              </td>
              <td>
                <TextNumberDisplay
                  value={
                    isPeriod.from === "" && isPeriod.to === "" ? 0 : totalDebit
                  }
              ...
              <td>
                <TextNumberDisplay
                  value={
                    isPeriod.from === "" && isPeriod.to === "" ? 0 : totalCredit
                  }
                  className="withPeso text-end inline-block w-full"
                />
              </td>
      ...
      if (itemData.id == item.id) {
        if (key === "debit") {
          return {
            ...
            credit: "",
            balance:
              Number(prevBalance) - Number(value) + Number(itemData.credit),
          };
        }
        if (key === "credit") {
          return {
            ...
            debit: "",
            balance:
              Number(prevBalance) - Number(value) + Number(itemData.debit),
          };
        }
        if (key === "date") {
          return {
            ...item,
            date: isDate.value === "" ? itemData.date : isDate.value,
          };
        }
        if (key === "remarks") {
          return {
              ...
              {Permission_modify && itemData.status !== "" && (
                <>
                  {isTableItem.length > 1 && (
                    <div className=" cursor-pointer" onClick={RemoveRowHandler}>
                      <MinusButtonTable />
                    </div>
                  )}
                </>
