...
export default function COAForm({
  ...
  const [isChartCode, setChartcode] = useState({
    parent: DefaultFormData.parent === undefined ? "" : DefaultFormData.parent,
  ...
  const Submit = (data: any) => {
    const Payload: ChartofAccountPayload = {
      ...
      parent_id:
        isParent.id === 0 || isParent.id === undefined || isParent.id === ""
          ? null
          : Number(isParent.id),
      ...
      <section>
        ...
        >
          <p className={style.modal_title}>
            {router.query.modify === undefined ? "Create" : "Modify"} Account
          </p>
          <h1 className={style.modal_label_primaryRed}>Primary Information</h1>
          <ul className={style.FinanceTwoRows}>
            ...
            <li className={style.twoField}>
              <article>
                ...
                {isError.parent_id && (
                  <p className="text-[10px]">{isError.parent_id}</p>
                )}
              </article>
              ...
              <article>
                ...
                />
                {isError.code_suffix && (
                  <p className="text-[10px]">{isError.code_suffix}</p>
                )}
              </article>
            </li>
            ...
            <li>
              ...
              {isError.account_name && (
                <p className="text-[10px]">{isError.account_name}</p>
              )}
            </li>
                  ...
                  toRef={
                    <>
                      <input
                        ...
                        autoComplete="off"
                        onClick={() => setBankAccountToggle(true)}
          ...
          <div className={style.SaveButton}>
            ...
            {router.query.modify !== undefined && Permission_modify && (
              <>
                {transaction ? (
                  <aside
            ...
            {(Permission_modify || router.query.modify === undefined) && (
