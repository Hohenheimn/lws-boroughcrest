...
export const GetRecordMeterByProperty = (
  reading_id: number,
  properties_id: number[]
) => {
  return useQuery(
    ["record-meter-list-by-property", reading_id, properties_id],
    () => {
      return api.get(
        `/finance/customer-facility/billing/record-meter-reading?billing_readings_name_id=${reading_id}&properties_id=${properties_id}`,
        {
          headers: {
            Authorization: "Bearer " + getCookie("user"),
          },
