...
export const GetInvoiceList = (
  ...
  return useQuery(
    ["invoice-list", keyword, type, TablePage, filterArray, dateFrom, dateTo],
    () => {
      return api.get(
...
export const GetInvoicePrint = (
  ...
  return useQuery(
    ["invoice-print", keyword, type, TablePage, filterArray, dateFrom, dateTo],
    () => {
      return api.get(
        `/finance/customer-facility/billing/print?list_type=${type}&paginate=10&keywords=${keyword}&page=${
          keyword === "" ? TablePage : 1
        }&filters=${filterArray}&date_from=${dateFrom}&date_to=${dateTo}`,
        {
          headers: { Authorization: "Bearer " + getCookie("user") },
...
export const ModifyInvoiceBilling = (onSuccess: any, onError: any, id: any) => {
  ...
  return useMutation(
    (Payload: any) => {
      return api.put(`/finance/customer-facility/billing/${id}`, Payload, {
        headers: {
          Authorization: "Bearer " + getCookie("user"),
        },
      });
