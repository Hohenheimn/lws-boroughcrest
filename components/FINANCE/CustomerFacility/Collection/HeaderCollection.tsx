    ...
    <>
      <section className={style.container}>
        <div className={style.searchBarAdvF}>
          {page !== "receive-payment" && (
            <>
              ...
              <AdvanceFilter
                endpoint={`${FilterEndpoint}?receipt_type=Acknowledgement,Official&date_from=${
                  isValid(dateFrom) ? format(dateFrom, "yyyy-MM-dd") : ""
                }&date_to=${
                  isValid(dateTo) ? format(dateTo, "yyyy-MM-dd") : ""
                }${
                  router.pathname.includes("/collection/payment-queueing")
                    ? "&status=Queued"
                    : ""
                }&keywords=`}
        ...
        <ul className={style.navigation}>
          ...
          {page === "payment-queueing" && (
            <li className={style.importExportPrint}>
              <Tippy theme="ThemeRed" content="Archive & Rejected">
                <div className={style.icon}>
