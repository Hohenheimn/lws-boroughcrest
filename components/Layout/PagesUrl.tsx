      ...
      const clone = Links.map((item) => {
        if (item.name === "admin") {
          ...
          if (
            userInfo?.permissions?.some(
              (someItem) =>
                someItem.menu === "Customer Request View (New Request)"
            ) ||
            userInfo?.permissions?.some(
              (someItem) =>
                someItem.menu === "Customer Request View (In Process)"
            ) ||
            userInfo?.permissions?.some(
              (someItem) =>
                someItem.menu === "Customer Request View (In Review)"
            ) ||
            userInfo?.permissions?.some(
              (someItem) => someItem.menu === "Customer Request View (Closed)"
            )
          ) {
            if (
              ValidatePermissionPage("Customer Request View (New Request)") ||
              ValidatePermissionPage("Customer Request View (In Process)") ||
              ValidatePermissionPage("Customer Request View (In Review)") ||
              ValidatePermissionPage("Customer Request View (Closed)")
            ) {
              addLinks = [
                ...addLinks,
                {
        ...
        if (item.name === "finance") {
          ...
          if (
            ...
            const urlRedirect = FinanceRedirect(`general ledger`, userInfo);
          ...
          if (
            ...
            const urlRedirect = FinanceRedirect(`customer facility`, userInfo);
            addLinks = [
              ...addLinks,
              {
          ...
          if (
            ...
            const urlRedirect = FinanceRedirect(`reports`, userInfo);
            addLinks = [
              ...addLinks,
              {
                name: "Reports",
